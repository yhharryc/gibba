...
public class GameFeelComponent : MonoBehaviour
{
    [Header("Components")]
    MovementComponent moveScript;
    JumpComponent jumpScript;
    ...
    void Start()
    {
        moveScript = GetComponent<MovementComponent>();
        jumpScript = GetComponent<JumpComponent>();
    }
